  ...
  return (
    ...
    <Router>
      <nav className="navbar align-content-center " style={{ display: "flex", backgroundColor: "rgba(135,150,180, 0.10)", }} >
        <Link to="/">
          <img src={Logo2} alt='Logo Icon' className="navbar-brand" width="140px" />
        </Link>
        <div><Link to='/signIn'><button type="button" className="btn btn-dark" style={{ margin: "15px" }}>Sign In</button></Link></div>
